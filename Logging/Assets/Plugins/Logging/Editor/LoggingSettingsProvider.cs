...
{
	public LoggingSettingsProvider(string path, SettingsScope scope = SettingsScope.User) : base(path, scope) { }
	...
	{
		var provider = new LoggingSettingsProvider("Project/Zuizui/Logging", SettingsScope.Project);
		return provider;
	}
}